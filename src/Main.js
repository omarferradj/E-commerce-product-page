    ...
    <>
      ...
      <div className="main">
        ...
        <div className="infos">
          ...
          <div className="buying-container">
            <div className="quantite">
              <button className="q-btn" onClick={decreaseQuantity}>
                -
              </button>
              <p>{quantity}</p>
              <button className="q-btn" onClick={increaseQuantity}>
                +
              </button>
            </div>
        ...
        <p className="coded-by">
          Coded by{" "}
          <a href="https://github.com/omarferradj/E-commerce-product-page">
            Omar Ferradj
          </a>
        </p>
      </div>
